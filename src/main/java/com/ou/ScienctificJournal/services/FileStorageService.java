 ...
 */
package com.ou.ScienctificJournal.services;

import com.ou.ScienctificJournal.exception.FileStorageException;
import com.ou.ScienctificJournal.exception.MyFileNotFoundException;
...
public class FileStorageService {
    ...
    public String storeFile(MultipartFile file, String version) {
        // Normalize file name
        String fileName = StringUtils.cleanPath(file.getOriginalFilename()+ version);
